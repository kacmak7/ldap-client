...
<head>
    <title><fmt:message key="print.confirmation-tome"/></title>
    <meta name="heading" content="<fmt:message key='print.confirmation-tome'/>"/>
...
<c:set var="buttons">
    ...
    <c:url value="/tomes/confirmationTome.html" var="confirmationTomeUrl"/>
    <form:form commandName="bapConDeaFilter" id="confirmationFilterForm" action="${confirmationTomeUrl}">
...
<display:table name="personsList" cellspacing="0" cellpadding="0" requestURI="" 
    ...
    <display:column property="firstName" escapeXml="true" sortable="true" titleKey="print.family.first-name" style="width: 25%"
        url="/print/personform.html" paramId="personId" paramProperty="id" media="html"/>
    <display:column property="remaining.confirmation.fileNumber" escapeXml="true" sortable="true" titleKey="print.remaining.confirmation-filenumber" style="width: 25%"
        url="/print/personform.html" paramId="personId" paramProperty="id" media="html"/>
    <display:column property="remaining.confirmation.date" escapeXml="true" sortable="true" titleKey="print.remaining.confirmation-date" style="width: 25%"
    ...
    <display:column property="firstName" escapeXml="true" titleKey="print.family.first-name" style="width: 25%"
        media="excel pdf"/>
    <display:column property="remaining.confirmation.fileNumber" escapeXml="true" titleKey="print.remaining.confirmation-filenumber" style="width: 25%"
        media="excel pdf"/>
    <display:column property="remaining.confirmation.date" escapeXml="true" titleKey="print.remaining.confirmation-date" style="width: 25%"
