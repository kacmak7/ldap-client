...
/*Workaround zgodnie z http://jira.codehaus.org/browse/DISPL-292 co by dzialal export.amount */
...
public class TableTag extends HtmlTableTag
{
    ...
    protected int doExport() throws JspException
    {
        ...
        if (exportFullList) // Makes wysiwyg exporters oberve export.amount config.
        {
