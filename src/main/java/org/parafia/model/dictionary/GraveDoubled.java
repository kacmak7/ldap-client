...
@Entity
@Table(name="grave_doubled")
public class GraveDoubled extends BaseObject {
	private static final long serialVersionUID = -5186542033337291483L;
	...
	public boolean equals(Object object) {
		if (!(object instanceof GraveDoubled)) {
			return false;
		}
		GraveDoubled rhs = (GraveDoubled) object;
