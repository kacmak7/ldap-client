...
public class TomeBaptismListControllerTest {
	...
	{
		mvc.perform(MockMvcRequestBuilders.get("/tomes/baptismTome.html"))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.view().name("tomes/baptismTome"));
	}
	...
	public void onSubmit() throws Exception {
		...
		Baptism baptism = (Baptism) ObjectTraverser.fillMockData(Baptism.class, person, "test", 1);
		
		MockHttpServletRequestBuilder rb = MockMvcRequestBuilders.post("/tomes/baptismTome.html");
		rb = ObjectTraverser.traverse(rb, baptism, null, null);
		mvc.perform(rb)
			.andExpect(MockMvcResultMatchers.status().isOk())
			.andExpect(MockMvcResultMatchers.view().name("/tomes/baptismTome"));
	}
