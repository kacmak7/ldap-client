...
public class TomeFianceesListControllerTest {
	...
	{
		mvc.perform(MockMvcRequestBuilders.get("/tomes/fianceesTome.html"))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.view().name("tomes/fianceesTome"));
	}
	...
	public void onSubmit() throws Exception 
	{
		...
		MockHttpServletRequestBuilder rb = MockMvcRequestBuilders.post("/tomes/fianceesTome.html");
