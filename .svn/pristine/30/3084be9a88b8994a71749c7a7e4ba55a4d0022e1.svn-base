...
@Entity
@Table(name="marriage_statuses")
public class MarriageStatus extends BaseObject {
	private static final long serialVersionUID = 2072546900772448792L;
	...
	public boolean equals(Object object) {
		if (!(object instanceof MarriageStatus)) {
			return false;
		}
		MarriageStatus rhs = (MarriageStatus) object;
