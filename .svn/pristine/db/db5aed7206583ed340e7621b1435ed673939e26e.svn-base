...
@Entity
@Table(name="grave_owned")
public class GraveOwned extends BaseObject {
	private static final long serialVersionUID = 3682862956172370783L;
	...
	public boolean equals(Object object) {
		if (!(object instanceof GraveOwned)) {
			return false;
		}
		GraveOwned rhs = (GraveOwned) object;
